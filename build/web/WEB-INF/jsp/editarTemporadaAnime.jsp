<%-- 
    Document   : editarTemporadaAnime
    Created on : 15/07/2022, 04:09:01 PM
    Author     : Raúl
--%>
...
<head>
    ...
    <title>Actualiza Temporadas Anime</title>
    ...
    <div class="col-md-5 offset-md-3 text-white">
        <div class="card">
            <div class="card-header bg-success">
                <h3 class="text-white text-center">Actualizar Temporada Anime</h3>
                <div style="float: right">
                    <a class="btn btn-outline-light"
                        href="editarTemporadaAnimeEmision.htm?idTemporada=${Lista[0].idTemporada}">Emision</a>
                </div>
            </div>
                ...
                <form method="POST">
                    ...
                    <div class="card-body">
                        <div class="input-group mb-3">
                            <label class="input-group-text" for="idAnime"
                                style="color: #adb5bd; background-color: #444;">Anime</label>
                            <select name="idAnime" id="idAnime" class="form-select" aria-label="Default select example"
                                required autofocus>
                                <option selected value="${Lista[0].idAnime}">${ListaTemporada[0].Anime}</option>
                                <option disabled value="">Selecciona un Anime</option>
                                <c:forEach var="dato" items="${ListaAnime}">
                                    <option value="${dato.idAnime}">${dato.Nombre}</option>
                                </c:forEach>
                            </select>
                        </div>
                    </div>
                    ...
                    <!-- Nombre -->
                    <div class="card-body">
                        <input type="text" name="nombre" placeholder="Nombre de la Temporada:" class="form-control" required value="${Lista[0].Nombre}">
                    </div>

                    <!-- Otros Nombres -->
                    <div class="card-body">
                        <textarea name="OtroNombre" placeholder="Otros Nombres:" class="form-control" cols="30" rows="5"
                            required>${Lista[0].OtrosNombres}</textarea>
                    </div>

                    <!-- Capitulos -->
                    <div class="card-body">
                        <input type="number" name="capitulos" class="form-control" placeholder="Capitulos" required
                            value="${Lista[0].capitulos}" />
                    </div>
                    ...
                    <div class="card-body">
                        <div class="input-group mb-3">
                            <label class="input-group-text" for="idioma"
                                style="color: #adb5bd; background-color: #444;">Idioma</label>
                            <select name="idioma" id="idioma" class="form-select" aria-label="Default select example"
                                required>
                                <option selected value="${Lista[0].idioma}">${Lista[0].idioma}</option>
                                <option disabled>Selecciona el Idioma</option>
                    ...
                    <div class="card-body">
                        <div class="input-group mb-3">
                            ...
                            <select name="idTemporadaEmision" id="TemporadaEmision" class="form-select"
                                ...
                                <option selected value="${Lista[0].idTemporadaEmision}">${ListaTemporada[0].Emision}
                                </option>
                                <option disabled value="">Selecciona la Temporada de Emision</option>
                    ...
                    <div class="card-body">
                        <div class="input-group mb-3">
                            ...
                            <select name="idEstudio" id="idEstudio" class="form-select"
                                aria-label="Default select example" required>
                                <option selected value="${Lista[0].idEstudio}">${ListaTemporada[0].Estudio}</option>
                                <option disabled value="">Selecciona el Estudio de Animacion</option>
                    ...
                    <div class="card-body">
                        <input type="number" name="calificacion" class="form-control" placeholder="Calificacion"
                            step="0.01" min="0" max="10" required value="${Lista[0].Calificacion}" />
                    </div>
                    ...
                    <a href="listaTemporadaAnime.htm" class="btn btn-outline-success">Regresar</a>
                </form>
            </div>
        </div>
    </div>
