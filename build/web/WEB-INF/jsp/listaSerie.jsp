<%-- 
    Document   : listaSerie
    Created on : 14/07/2022, 04:37:24 PM
    Author     : Raúl
--%>
...
<body>
    ...
    <div class="card text-white text-center">
        <div class="card-header bg-success">
            <h4 class="text-white">Lista General Series</h4>
            <div style="float: left">
                <a class="btn btn-outline-light" href="altaSerie.htm">Agregar Registro</a>
            </div>
            <div style="float: right">
                <a class="btn btn-outline-light" href="listaAuditoriaSerie.htm">Ver Cambios</a>
            </div>
        </div>
                ...
                <tbody>
                    <c:forEach var="dato" items="${Lista}">
                        <tr>
                            ...
                            <td>
                                <a href="editarSerie.htm?idSerie=${dato.idSerie}" class="btn btn-warning">
                                ...
                                <a href="eliminarSerie.htm?idSerie=${dato.idSerie}"
...
<script src="js/Exportar/Serie.js"></script>
