<%-- 
    Document   : buscarAnimesTemporada
    Created on : 16/07/2022, 10:52:19 PM
    Author     : Raúl
--%>
...
<body>
    ...
    <div class="card text-white text-center">
        <div class="card-header bg-success">
            <h3 class="text-white">Animes de la Temporadas: <br>${Nombre[0].Emision}</h3>
            ...
            <div style="float: right">
                ...
                <a class="btn btn-outline-light" href="buscarAnimesTemporada2.htm?idTemporada=${Nombre[0].idTemporada}">Otra Vista</a>
            </div>
        </div>
        <div class="card-body bg-dark scrollmenu">
            ...
            <a href="listaTemporadasEmision.htm" class="btn btn-outline-success btn-lg">Regresar</a>
        </div>
    </div>
    <!-- Tabla Fin -->
