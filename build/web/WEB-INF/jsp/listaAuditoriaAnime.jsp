<%-- 
    Document   : listaAuditoriaAnime
    Created on : 15/07/2022, 03:24:49 PM
    Author     : Raúl
--%>
...
<head>
    ...
    <title>Lista Cambios Anime</title>
...
<body>
    ...
    <div class="card text-white text-center">
        <div class="card-header bg-success">
            <h4 class="text-white">Lista General de Cambios Animes</h4>
            <div style="float: right">
                <a class="btn btn-outline-light" href="listaAnime.htm">Ver Registros</a>
            </div>
