<%-- 
    ...
    Created on : 13/07/2022, 10:48:34 PM
    Author     : Raúl
--%>
...
<head>
    ...
    <title>Actualiza Pelicula</title>
        ...
        <div class="container text-center py-5">
            ...
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center mb-0">
                    ...
                    <li class="breadcrumb-item text-primary active" aria-current="page"><a style="color: #0d6efd;" href="Peliculas.htm">Peliculas</a></li>
    ...
    <div class="col-md-5 offset-md-3 text-white">
        <div class="card">
            <div class="card-header bg-success">
                <h3 class="text-white text-center">Actualizar Pelicula</h3>
            </div>
                ...
                <form method="POST">
                    ...
                    <div class="card-body">
                        <input type="text" name="otrosNombres" placeholder="Otros Nombres de la Pelicula:"
                            class="form-control" required value="${ListaPeliculas[0].otrosNombres}">
                    </div>
                    ...
                    <div class="card-body">
                        <div class="input-group mb-3">
                            ...
                            <select name="idProductora" id="Productora" class="form-select"
                                ...
                                <option selected value="${Lista[0].idProductora}">${ListaPeliculas[0].Productora}
                                </option>
                    ...
                    <div class="card-body">
                        <div class="input-group mb-3">
                            ...
                            <select name="idDistribuidora" id="Distribuidora" class="form-select"
                                aria-label="Default select example" required>
                                <option selected value="${Lista[0].idDistribuidora}">${ListaPeliculas[0].Distribuidora}
                                </option>
                                <option disabled value="">Selecciona una Distribuidora</option>
                    ...
                    <div class="card-body">
                        <div class="input-group mb-3">
                            ...
                            <select name="genero" id="Genero" class="form-select" aria-label="Default select example"
                                required>
                                <option selected value="${Lista[0].Genero}">${ListaPeliculas[0].Genero}</option>
                    ...
                    <div class="card-body">
                        <div class="input-group mb-3">
                            <label class="input-group-text" for="Tipo"
                                style="color: #adb5bd; background-color: #444;">Tipo de Pelicula</label>
                            <select name="tipo" id="Tipo" class="form-select" aria-label="Default select example"
                                required>
                                <option selected value="${Lista[0].Tipo}">${Lista[0].Tipo}</option>
                                <option disabled value="">Selecciona un Tipo de Pelicula</option>
                    ...
                    <div class="card-body">
                        <div class="input-group mb-3">
                            ...
                            <select name="clasificacion" id="Clasificacion" class="form-select"
                                aria-label="Default select example" required>
                                <option selected value="${Lista[0].Clasificacion}">${ListaPeliculas[0].Clasificacion}
                                </option>
                                <option disabled value="">Clasificacion de la Pelicula</option>
                    ...
                    <div class="card-body">
                        <div class="input-group mb-3">
                            <label class="input-group-text" for="Estreno"
                                style="color: #adb5bd; background-color: #444;">Estreno Oficial</label>
                            <input type="date" id="Estreno" name="estreno" class="form-control" required
                                value="${Lista[0].Estreno}" />
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="input-group mb-3">
                            <label class="input-group-text" for="EstrenoMexico"
                                style="color: #adb5bd; background-color: #444;">Estreno en México</label>
                            <input type="date" id="EstrenoMexico" name="estrenoMexico" class="form-control" required
                                value="${Lista[0].EstrenoMexico}" />
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="input-group mb-3">
                            ...
                            <select name="idDirector" id="Director" class="form-select"
                                aria-label="Default select example" required>
                                <option selected value="${Lista[0].idDirector}">${ListaPeliculas[0].Director}</option>
                    ...
                    <a href="listaPelicula.htm" class="btn btn-outline-success">Regresar</a>
                </form>
            </div>
        </div>
    </div>
