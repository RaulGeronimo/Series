<%-- 
    Document   : editarTemporadasEmision
    Created on : 15/07/2022, 01:37:37 PM
    Author     : Raúl
--%>
...
<head>
    ...
    <title>Actualiza Temporadas Emision</title>
    ...
    <div class="col-md-5 offset-md-3 text-white">
        <div class="card">
            <div class="card-header bg-success">
                <h3 class="text-white text-center">Actualizar Temporada Emision</h3>
            </div>
            <div class="card-body bg-dark">
                <form method="POST">
                    ...
                    <a href="listaTemporadasEmision.htm" class="btn btn-outline-success">Regresar</a>
                </form>
            </div>
        </div>
    </div>
