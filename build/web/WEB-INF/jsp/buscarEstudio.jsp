<%-- 
    Document   : buscarEstudio
    Created on : 21/07/2022, 11:48:15 PM
    Author     : Raúl
--%>
    ...
    <div class="card text-white text-center">
        <div class="card-header bg-success">
            <c:forEach var="dato" items="${Estudio}">
                <h4 class="text-white">Animes animados por: <br>${dato.Estudio}</h4>
            </c:forEach>
            ...
            <div style="float: right">
                ...
                <a class="btn btn-outline-light" href="buscarEstudio2.htm?idEstudio=${Conteo[0].idEstudio}">Otra Vista</a>
            </div>
        </div>
        <div class="card-body bg-dark scrollmenu">
            ...
            <a href="listaEstudio.htm" class="btn btn-outline-success btn-lg">Regresar</a>
        </div>
    </div>
    <!-- Tabla Fin -->
