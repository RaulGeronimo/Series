<%-- 
    Document   : altaTemporadasEmision
    Created on : 15/07/2022, 01:37:52 PM
    Author     : Raúl
--%>
...
<head>
    ...
    <title>Alta Temporadas Emision Anime</title>
    ...
    <div class="col-md-5 offset-md-3 text-white">
        <div class="card">
            <div class="card-header bg-success">
                <h3 class="text-white text-center">Nueva Temporada Emision</h3>
            </div>
