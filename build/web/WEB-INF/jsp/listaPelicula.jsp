<%-- 
    ...
    Created on : 13/07/2022, 10:45:33 PM
    Author     : Raúl
--%>
...
<body>
    ...
    <div class="card text-white text-center">
        <div class="card-header bg-success">
            <h4 class="text-white">Lista General Peliculas</h4>
            <div style="float: left">
                <a class="btn btn-outline-light" href="altaPelicula.htm">Agregar Registro</a>
            </div>
            <div style="float: right">
                <a class="btn btn-outline-light" href="listaAuditoriaPelicula.htm">Ver Cambios</a>
            </div>
        </div>
        <div class="card-body bg-dark scrollmenu">
                ...
                <tbody>
                    <c:forEach var="dato" items="${Lista}">
                        <tr>
                            ...
                            <td>
                                <a href="editarPelicula.htm?idPelicula=${dato.idPelicula}" class="btn btn-warning">
                                ...
                                <a href="eliminarPelicula.htm?idPelicula=${dato.idPelicula}"
            ...
            <a href="Peliculas.htm" class="btn btn-outline-success btn-lg">Regresar</a>
        </div>
    </div>
    <!-- Tabla Fin -->
...
<script src="js/Exportar/Pelicula.js"></script>
