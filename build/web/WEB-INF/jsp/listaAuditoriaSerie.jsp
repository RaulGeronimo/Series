<%-- 
    Document   : listaAuditoriaSerie
    Created on : 14/07/2022, 05:11:19 PM
    Author     : Raúl
--%>
...
<head>
    ...
    <title>Lista Cambios Serie</title>
...
<body>
    ...
    <div class="card text-white text-center">
        <div class="card-header bg-success">
            <h4 class="text-white">Lista General de Cambios Series</h4>
            <div style="float: right">
                <a class="btn btn-outline-light" href="listaSerie.htm">Ver Registros</a>
            </div>
