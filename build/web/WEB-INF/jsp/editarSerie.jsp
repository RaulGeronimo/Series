<%-- 
    ...
    Created on : 14/07/2022, 04:37:14 PM
    Author     : Raúl
--%>
    ...
    <div class="col-md-5 offset-md-3 text-white">
        <div class="card">
            <div class="card-header bg-success">
                <h3 class="text-white text-center">Actualizar Serie</h3>
            </div>
            <div class="card-body bg-dark">
                <form method="POST">
                    ...
                    <!-- Nombre -->
                    <div class="card-body">
                        <input type="text" name="nombre" placeholder="Nombre de la Serie:" class="form-control"
                    ...
                    <div class="card-body">
                        <div class="input-group mb-3">
                            ...
                            <select name="genero" id="Genero" class="form-select" aria-label="Default select example"
                                required>
                                <option selected value="${Lista[0].Genero}">${ListaSerie[0].Genero}
                                </option>
                    ...
                    <div class="card-body">
                        <div class="input-group mb-3">
                            ...
                            <select name="idProductora" id="Productora" class="form-select"
                                ...
                                <option selected value="${Lista[0].idProductora}">${ListaSerie[0].Productora}
                                </option>
                    ...
                    <div class="card-body">
                        <div class="input-group mb-3">
                            ...
                            <select name="idDistribuidora" id="Distribuidora" class="form-select"
                                aria-label="Default select example" required>
                                <option selected value="${Lista[0].idDistribuidora}">${ListaSerie[0].Distribuidora}
                                </option>
                    ...
                    <div class="card-body">
                        <div class="input-group mb-3">
                            ...
                            <select name="idDirector" id="Director" class="form-select"
                                aria-label="Default select example" required>
                                <option selected value="${Lista[0].idDirector}">${ListaSerie[0].Director}</option>
                    ...
                    <a href="listaSerie.htm" class="btn btn-outline-success">Regresar</a>
                </form>
            </div>
        </div>
    </div>
