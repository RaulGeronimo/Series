<%-- 
    Document   : listaAuditoriaTemporadaSerie
    Created on : 14/07/2022, 06:25:02 PM
    Author     : Raúl
--%>
...
<head>
    ...
    <title>Lista Cambios Temporadas Serie</title>
...
<body>
    ...
    <div class="card text-white text-center">
        <div class="card-header bg-success">
            <h4 class="text-white">Lista General de Cambios Temporadas Series</h4>
            <div style="float: right">
                <a class="btn btn-outline-light" href="listaTemporadaSerie.htm">Ver Registros</a>
            </div>
