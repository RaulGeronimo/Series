<%-- 
    ...
    Created on : 15/07/2022, 02:55:08 PM
    Author     : Raúl
--%>
    ...
    <div class="col-md-5 offset-md-3 text-white">
        <div class="card">
            <div class="card-header bg-success">
                <h3 class="text-white text-center">Actualizar Anime</h3>
            </div>
            <div class="card-body bg-dark">
                <form method="POST">
                    ...
                    <!-- Nombre -->
                    <div class="card-body">
                        <input type="text" name="nombre" placeholder="Nombre del Anime:" class="form-control" autofocus
                    ...
                    <!-- Genero -->
                    <div class="card-body">
                        <textarea value="${Lista[0].Genero}" name="genero" placeholder="Genero:" class="form-control"
                            cols="30" rows="3" required>${Lista[0].Genero}</textarea>
                    </div>

                    <br><button type="submit" class="btn btn-outline-primary">Actualizar</button>
                    <a href="listaAnime.htm" class="btn btn-outline-success">Regresar</a>
                </form>
            </div>
        </div>
    </div>
