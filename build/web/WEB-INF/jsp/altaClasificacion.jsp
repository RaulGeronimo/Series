<%-- 
    Document   : altaClasificacion
    Created on : 13/07/2022, 06:52:05 PM
    Author     : Raúl
--%>
    ...
    <div class="col-md-5 offset-md-3 text-white">
        <div class="card">
            <div class="card-header bg-success">
                <h3 class="text-white text-center">Nueva Clasificacion</h3>
            </div>
            <div class="card-body bg-dark">
                <form method="POST">
                    ...
                    <!-- Nombre -->
                    <div class="card-body">
                        <input type="text" name="nombre" placeholder="Nombre de la Clasificacion:" class="form-control"
                            autofocus required>
                    </div>
                    ...
                    <a href="listaClasificacion.htm" class="btn btn-outline-success">Regresar</a>
                </form>
            </div>
        </div>
    </div>
