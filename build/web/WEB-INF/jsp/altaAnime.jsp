<%-- 
    Document   : altaAnime
    Created on : 15/07/2022, 02:55:16 PM
    Author     : Raúl
--%>
    ...
    <div class="col-md-5 offset-md-3">
        <div class="card">
            <div class="card-header bg-success">
                <h3 class="text-white text-center">Nuevo Anime</h3>
            </div>
            <div class="card-body bg-dark">
                <form method="POST" autocomplete="off">
                    ...
                    <!-- Genero -->
                    <div class="card-body">
                        <textarea name="genero" placeholder="Genero:" class="form-control" cols="30" rows="3"
                            required></textarea>
                    </div>
