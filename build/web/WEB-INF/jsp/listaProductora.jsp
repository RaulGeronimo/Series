<%-- 
    Document   : listaProductora
    Created on : 13/07/2022, 04:01:13 PM
    Author     : Raúl
--%>
...
<body>
    ...
    <div class="card text-white" style="margin-bottom: 1rem;">
        <div class="card-header bg-success">
            <h4 class="text-white">Lista General Productora</h4>
            <div style="float: right">
                <a class="btn btn-outline-light" href="altaProductora.htm">Agregar Registro</a>
                <a href="Contenido.htm" class="btn btn-outline-light">Regresar</a>
            </div>
            <div style="float: left">
                <c:forEach var="dato" items="${Conteo}">
                    <p>Total de Productoras: ${dato.Productora}</p>
                </c:forEach>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-4" style="margin-bottom: 1.5rem;">
                <div class="card text-center bg-dark scrollmenu">
                    <div class="card-header text-white d-flex justify-content-between align-items-center text-center">
                        ${dato.Nombre}
                        <a href="eliminarProductora.htm?idProductora=${dato.idProductora}"
                            onclick="return confirm('¿Estás seguro que deseas eliminar el registro?')"
                            class="btn btn-danger"><i class="far fa-trash-alt"></i></a>
                    </div>
                    <img src="${dato.Imagen}" style="margin-left: auto; margin-right: auto; height: 200px;"
                    ...
                    <div class="card-body text-white">
                        ...
                        <a class="btn btn-outline-success"
                            href="editarProductora.htm?idProductora=${dato.idProductora}">
                            Editar Productora
                        </a>
                    </div>
                </div>
