<%-- 
    Document   : listaAuditoriaUsuario
    Created on : 11/07/2022, 01:19:54 PM
    Author     : Raúl
--%>
...
<head>
    ...
    <title>Lista Cambios Usuario</title>
...
<body>
            ...
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center mb-0">
                    ...
                    <li class="breadcrumb-item text-primary active" aria-current="page"><a style="color: #0d6efd;"
                            href="listaUsuario.htm">Usuarios</a></li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="card text-white text-center">
        <div class="card-header bg-success">
            <h4 class="text-white">Lista General de Cambios Usuario</h4>
            <div style="float: right">
                <a class="btn btn-outline-light" href="listaUsuario.htm">Ver Registros</a>
            </div>
