<%-- 
    Document   : listaEstudio2
    Created on : 8/12/2022, 12:04:38 AM
    Author     : raul0
--%>
    ...
    <div class="card text-white text-center">
        <div class="card-header bg-success">
            ...
            <div style="float: right">
                ...
                <a class="btn btn-outline-light" href="listaEstudio.htm">Otra Vista</a>
            </div>
        </div>
                ...
                <tbody>
                    <c:forEach var="dato" items="${Lista}">
                        <tr>
                            ...
                            <td>
                                <a href="editarEstudio.htm?idEstudio=${dato.idEstudio}" class="btn btn-warning">
                                ...
                                <a target="_blank" href="buscarEstudio.htm?idEstudio=${dato.idEstudio}"
...
<script src="js/Exportar/Estudio.js"></script>
