<%-- 
    Document   : editarTemporadaSerie
    Created on : 14/07/2022, 05:38:04 PM
    Author     : Raúl
--%>
...
<head>
    ...
    <title>Actualiza Temporadas Series</title>
    ...
    <div class="col-md-5 offset-md-3 text-white">
        <div class="card">
            <div class="card-header bg-success">
                <h3 class="text-white text-center">Actualizar Temporada Serie</h3>
                <div style="float: right">
                    <a class="btn btn-outline-light"
                        href="editarTemporadaSerieEmision.htm?idTemporada=${Lista[0].idTemporada}">Emision</a>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="input-group mb-3">
                            ...
                            <select name="idSerie" id="idSerie" class="form-select" aria-label="Default select example"
                                required autofocus>
                                <option selected value="${Lista[0].idSerie}">${ListaTemporada[0].Serie}</option>
