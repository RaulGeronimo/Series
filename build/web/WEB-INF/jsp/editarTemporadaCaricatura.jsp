<%-- 
    Document   : editarTemporadaCaricatura
    Created on : 14/07/2022, 11:09:19 PM
    Author     : Raúl
--%>
...
<head>
    ...
    <title>Actualiza Temporadas Caricaturas</title>
    ...
    <div class="col-md-5 offset-md-3 text-white">
        <div class="card">
            <div class="card-header bg-success">
                <h3 class="text-white text-center">Actualizar Temporada Caricatura</h3>
                <div style="float: right">
                    <a class="btn btn-outline-light"
                        href="editarTemporadaCaricaturaEmision.htm?idTemporada=${Lista[0].idTemporada}">Emision</a>
                </div>
            </div>
                ...
                <form method="POST">
                    ...
                    <div class="card-body">
                        <div class="input-group mb-3">
                            <label class="input-group-text" for="idCaricatura"
                                style="color: #adb5bd; background-color: #444;">Caricatura</label>
                            <select name="idCaricatura" id="idCaricatura" class="form-select"
                                aria-label="Default select example" required autofocus>
                                <option selected value="${Lista[0].idCaricatura}">${ListaTemporada[0].Caricatura}
                                </option>
                                <option disabled value="">Selecciona una Caricatura</option>
                                <c:forEach var="dato" items="${ListaCaricatura}">
                                    <option value="${dato.idCaricatura}">${dato.OtrosNombres}</option>
                                </c:forEach>
                            </select>
                        </div>
                    </div>
                    ...
                    <!-- Capitulos -->
                    <div class="card-body">
                        <input value="${Lista[0].capitulos}" type="number" name="capitulos" class="form-control"
                            placeholder="Capitulos" required />
                    </div>
                    ...
                    <a href="listaTemporadaCaricatura.htm" class="btn btn-outline-success">Regresar</a>
                </form>
            </div>
        </div>
    </div>
