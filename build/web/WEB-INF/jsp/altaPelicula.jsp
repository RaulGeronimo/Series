<%-- 
    ...
    Created on : 13/07/2022, 10:48:25 PM
    Author     : Raúl
--%>
        ...
        <div class="card">
            <div class="card-header bg-success">
                ...
                <div style="float: right">
                    <a class="btn btn-outline-light" href="altaPelicula1.htm">Proximamente</a>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="input-group mb-3">
                            ...
                            <select name="tipo" id="Tipo" class="form-select" aria-label="Default select example"
                                required>
                                <option selected disabled value="">Selecciona un Tipo de Pelicula</option>
                    ...
                    <div class="card-body">
                        <div class="input-group mb-3">
                            <label class="input-group-text" for="Estreno"
                                style="color: #adb5bd; background-color: #444;">Estreno</label>
