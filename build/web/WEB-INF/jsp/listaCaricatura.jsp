<%-- 
    Document   : listaCaricatura
    Created on : 14/07/2022, 10:23:22 PM
    Author     : Raúl
--%>
...
<body>
    ...
    <div class="card text-white text-center">
        <div class="card-header bg-success">
            <h4 class="text-white">Lista General Caricaturas</h4>
            <div style="float: left">
                <a class="btn btn-outline-light" href="altaCaricatura.htm">Agregar Registro</a>
            </div>
            <div style="float: right">
                <a class="btn btn-outline-light" href="listaAuditoriaCaricatura.htm">Ver Cambios</a>
            </div>
        </div>
                ...
                <tbody>
                    <c:forEach var="dato" items="${Lista}">
                        <tr>
                            ...
                            <td>
                                <a href="editarCaricatura.htm?idCaricatura=${dato.idCaricatura}"
                                ...
                                <a href="eliminarCaricatura.htm?idCaricatura=${dato.idCaricatura}"
                                ...
                                <a target="_blank" href="buscaTemporadaCaricatura2.htm?idCaricatura=${dato.idCaricatura}"
...
<script src="js/Exportar/Caricatura.js"></script>
