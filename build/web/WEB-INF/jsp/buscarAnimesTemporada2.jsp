<%-- 
    Document   : newjspbuscarAnimesTemporada2
    Created on : 16/12/2022, 09:14:41 PM
    Author     : raul0
--%>
...
<body>
    ...
    <div class="card text-white" style="margin-bottom: 1rem;">
        <div class="card-header bg-success">
            <h4 class="text-white">Animes de la Temporadas: ${Nombre[0].Emision}</h4>
            <div style="float: right">
                <a class="btn btn-outline-light" href="altaTemporadaAnime.htm">Agregar Registro</a>
                <a href="listaTemporadasEmision.htm" class="btn btn-outline-light">Regresar</a>
                <a class="btn btn-outline-light" href="listaAuditoriaTemporadaAnime.htm">Ver Cambios</a>
                <a class="btn btn-outline-light"
                    href="buscarAnimesTemporada.htm?idTemporada=${Nombre[0].idTemporada}">Otra Vista</a>
            </div>
            <div style="float: left">
                <p>Temporadas: ${Conteo[0].Conteo}, Promedio: ${Conteo[0].Promedio}</p>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-4" style="margin-bottom: 1.5rem;">
                <div class="card text-center bg-dark scrollmenu">
                    ...
                    <div class="card-body text-white">
                        ...
                        <p style="font-weight: bold;">Fecha Inicio</p>
                        <p>${dato.FechaInicio}</p>

                        <p style="font-weight: bold;">Fecha Fin</p>
                        <p>${dato.FechaFin}</p>
    ...
    <div class="card text-white" style="margin-bottom: 1rem;">
        <div class="card-header bg-success">
            <h4 class="text-white">Peliculas de la Temporadas: ${Nombre[0].Emision}</h4>
            <div style="float: right">
                <a class="btn btn-outline-light" href="altaTemporadaAnime.htm">Agregar Registro</a>
                <a href="listaTemporadasEmision.htm" class="btn btn-outline-light">Regresar</a>
                <a class="btn btn-outline-light" href="listaAuditoriaTemporadaAnime.htm">Ver Cambios</a>
            ...
            <div style="float: left">
                <p>Peliculas: ${Pelicula[0].Conteo}, Promedio: ${Pelicula[0].Promedio}</p>
            </div>
        </div>
    </div>
