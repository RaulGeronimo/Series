<%-- 
    Document   : Navegacion
    Created on : 11/07/2022, 09:19:38 PM
    Author     : Raúl
--%>
...
<body>
    ...
    <div class="container-fluid page-header py-5 mb-3 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <h1 class="display-4 text-white animated slideInDown mb-3">Navegacion por Celular</h1>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="">
                        <img class="img-fluid" src="img/QR.png" alt="">
                    </div>
                </div>
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="h-100">
                        <h6 class="section-title bg-white text-start text-primary pe-3">Codigo QR</h6>
                        <h1 class="display-6 mb-4">Escane el codigo.</h1>
                        <p>Para poder navegar a traves de la pagina, se utilizara un codigo QR.</p>
                        <p class="mb-4">Una vez estando en el sistema, el usuario podra insertar registros, asi como
                            modificarlos y eliminarlos.</p>
                    </div>
                </div>
            </div>
        </div>
