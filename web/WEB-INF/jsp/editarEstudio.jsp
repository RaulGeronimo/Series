<%-- 
    ...
    Created on : 4/11/2022, 02:14:41 PM
    Author     : Raúl
--%>
        ...
        <div class="card">
            ...
            <div class="card-body bg-dark">
                <form method="POST">
                    ...
                    <!-- Nombre -->
                    <div class="card-body">
                        <input type="text" name="nombre" placeholder="Nombre del Estudio de Animacion:"
                            class="form-control" autofocus required value="${Lista[0].nombre}">
                    </div>

                    <!-- Fundacion -->
                    <div class="card-body">
                        <div class="input-group mb-3">
                            <label class="input-group-text" for="Fundacion"
                                style="color: #adb5bd; background-color: #444;">Fundacion</label>
                            <input type="date" id="Fundacion" name="fundacion" class="form-control" required
                                value="${Lista[0].Fundacion}" />
                        </div>
                    </div>
                    ...
                    <a href="listaEstudio.htm" class="btn btn-outline-success">Regresar</a>
                </form>
            </div>
        </div>
    </div>
