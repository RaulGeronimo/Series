<%-- 
    Document   : listaAuditoriaDirector
    Created on : 13/07/2022, 08:01:19 PM
    Author     : Raúl
--%>
...
<head>
    ...
    <title>Lista Cambios Director</title>
...
<body>
    ...
    <div class="card text-white text-center">
        <div class="card-header bg-success">
            <h4 class="text-white">Lista General de Cambios Director</h4>
            <div style="float: right">
                <a class="btn btn-outline-light" href="listaDirector.htm">Ver Registros</a>
            </div>
