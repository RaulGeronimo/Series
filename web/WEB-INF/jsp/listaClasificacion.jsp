<%-- 
    Document   : listaClasificacion
    Created on : 13/07/2022, 06:52:15 PM
    Author     : Raúl
--%>
...
<head>
    ...
    <title>Lista Clasificacion</title>
...
<body>
    ...
    <div class="card text-white text-center">
        <div class="card-header bg-success">
            <h4 class="text-white">Lista General Clasificacion</h4>
            <div style="float: right">
                <a class="btn btn-outline-light" href="altaClasificacion.htm">Agregar Registro</a>
            </div>
...
<script src="./js/Exportar/Clasificacion.js"></script>
