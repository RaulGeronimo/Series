<%-- 
    Document   : listaAuditoriaTemporadaCaricatura
    Created on : 14/07/2022, 11:27:46 PM
    Author     : Raúl
--%>
...
<head>
    ...
    <title>Lista Cambios Temporadas Caricaturas</title>
...
<body>
    ...
    <div class="card text-white text-center">
        <div class="card-header bg-success">
            <h4 class="text-white">Lista General de Cambios Temporadas Caricatura</h4>
            <div style="float: right">
                <a class="btn btn-outline-light" href="listaTemporadaCaricatura.htm">Ver Registros</a>
            </div>
