<%-- 
    Document   : Peliculas
    Created on : 11/07/2022, 11:35:06 PM
    Author     : Raúl
--%>
        ...
        <div class="container text-center py-5">
            ...
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center mb-0">
                    ...
                    <li class="breadcrumb-item text-primary active">Peliculas</li>
        ...
        <div class="container">
            ...
            <div class="owl-carousel project-carousel wow fadeInUp" data-wow-delay="0.1s">
                ...
                <div class="project-item border rounded h-100 p-4" data-dot="03">
                    <div class="position-relative mb-4">
                        <img class="img-fluid rounded" src="img/Peliculas/Productora.jpg" alt="">
                        <a href="listaProductora.htm"><i class="fa fa-eye fa-2x"></i></a>
                    </div>
                    <h6>Productora / Distribuidora</h6>
                    <span>La industria cinematografica de la pelicula, el que lo distribuye.</span>
                </div>
                <!-- Clasificacion -->
