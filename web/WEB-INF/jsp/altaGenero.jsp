<%-- 
    Document   : altaGenero
    Created on : 13/07/2022, 04:17:43 PM
    Author     : Raúl
--%>
...
<body>
    ...
    <div class="container-fluid page-header py-5 mb-3 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <h1 class="display-4 text-white animated slideInDown mb-3">Genero</h1>
    ...
    <div class="col-md-5 offset-md-3 text-white">
        <div class="card">
            <div class="card-header bg-success">
                <h3 class="text-white text-center">Nuevo Genero</h3>
            </div>
            <div class="card-body bg-dark">
                <form method="POST">
                    ...
                    <!-- Nombre -->
                    <div class="card-body">
                        <input type="text" name="nombre" placeholder="Nombre del Genero:" class="form-control" autofocus
                            required>
                    </div>

                    <!-- Descripcion -->
                    <div class="card-body">
                        <textarea name="descripcion" placeholder="Descripcion:" class="form-control" cols="30" rows="10"
                            required></textarea>
                    </div>

                    <br><button type="submit" class="btn btn-outline-primary">Agregar</button>
                    <a href="listaGenero.htm" class="btn btn-outline-success">Regresar</a>
                </form>
            </div>
        </div>
    </div>
