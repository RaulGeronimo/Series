<%-- 
    Document   : listaTemporadasEmision
    Created on : 15/07/2022, 01:37:24 PM
    Author     : Raúl
--%>
...
<head>
    ...
    <title>Lista Temporadas Emision</title>
...
<body>
    ...
    <div class="card text-white text-center">
        <div class="card-header bg-success">
            <h4 class="text-white">Lista General Temporadas Emision</h4>
            <div style="float: left">
                <a class="btn btn-outline-light" href="altaTemporadasEmision.htm">Agregar Registro</a>
            </div>
            <div style="float: right">
                <a class="btn btn-outline-light" href="listaAuditoriaTemporadasEmision.htm">Ver Cambios</a>
            </div>
        </div>
        <div class="card-body bg-dark scrollmenu">
                ...
                <tbody>
                    <c:forEach var="dato" items="${Lista}">
                        <tr>
                            ...
                            <td>${dato.Promedio}</td>
                            <td>
                                <a href="editarTemporadasEmision.htm?idTemporada=${dato.idTemporada}"
                                ...
                                <a href="eliminarTemporadasEmision.htm?idTemporada=${dato.idTemporada}"
                                ...
                                <a target="_blank" href="buscarAnimesTemporada2.htm?idTemporada=${dato.idTemporada}"
            ...
            <a href="Anime.htm" class="btn btn-outline-success btn-lg">Regresar</a>
        </div>
    </div>
    <!-- Tabla Fin -->
...
<script src="js/Exportar/Emision.js"></script>
