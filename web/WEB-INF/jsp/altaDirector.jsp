        ...
        <div class="card">
            <div class="card-header bg-success">
                ...
                <div style="float: right">
                    <a class="btn btn-outline-light" href="altaDirectorInactivo.htm">Director Inactivo</a>
                </div>
            </div>
            <div class="card-body bg-dark">
                <form method="POST">
                    ...
                    <!-- Apellidos -->
                    <div class="card-body">
                        <input type="text" name="apellidos" placeholder="Apellidos del Director:" class="form-control" required>
                    </div>
