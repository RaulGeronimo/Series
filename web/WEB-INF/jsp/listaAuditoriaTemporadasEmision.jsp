<%-- 
    Document   : listaAuditoriaTemporadasEmision
    Created on : 15/07/2022, 02:38:46 PM
    Author     : Raúl
--%>
...
<head>
    ...
    <title>Lista Cambios Temporadas Emision Anime</title>
...
<body>
    ...
    <div class="card text-white text-center">
        <div class="card-header bg-success">
            <h4 class="text-white">Lista General de Cambios Temporadas Emision</h4>
            <div style="float: right">
                <a class="btn btn-outline-light" href="listaTemporadasEmision.htm">Ver Registros</a>
            </div>
