<%-- 
    Document   : buscarEstudio1
    Created on : 16/12/2022, 09:20:05 PM
    Author     : raul0
--%>
...
<body>
    ...
    <div class="card text-white" style="margin-bottom: 1rem;">
        <div class="card-header bg-success">
            <c:forEach var="dato" items="${Estudio}">
                <h4 class="text-white">Animes animados por: ${dato.Estudio}</h4>
            </c:forEach>
            <div style="float: right">
                <a class="btn btn-outline-light" href="altaTemporadaAnime.htm">Agregar Registro</a>
                <a href="listaEstudio.htm" class="btn btn-outline-light">Regresar</a>
                <a class="btn btn-outline-light" href="listaAuditoriaTemporadaAnime.htm">Ver Cambios</a>
                <a class="btn btn-outline-light" href="buscarEstudio.htm?idEstudio=${Estudio[0].idEstudio}">Otra
                    Vista</a>
            </div>
            <div style="float: left">
                <p>Temporadas: ${Conteo[0].Conteo}</p>
            </div>
        </div>
    </div>
    ...
    <div class="card text-white" style="margin-bottom: 1rem;">
        <div class="card-header bg-success">
            <c:forEach var="dato" items="${Estudio}">
                <h4 class="text-white">Peliculas de: ${dato.Estudio}</h4>
            </c:forEach>
            <div style="float: right">
                <a class="btn btn-outline-light" href="altaTemporadaAnime.htm">Agregar Registro</a>
                <a href="listaEstudio.htm" class="btn btn-outline-light">Regresar</a>
            ...
            <div style="float: left">
                <p>Peliculas: ${Pelicula[0].Conteo}</p>
            </div>
        </div>
    </div>
