<%-- 
    Document   : listaAuditoriaTemporadaAnime
    Created on : 15/07/2022, 07:19:54 PM
    Author     : Raúl
--%>
...
<head>
    ...
    <title>Lista Cambios Temporadas Anime</title>
...
<body>
    ...
    <div class="card text-white text-center">
        <div class="card-header bg-success">
            <h4 class="text-white">Lista General de Cambios Temporadas Anime</h4>
            <div style="float: right">
                <a class="btn btn-outline-light" href="listaTemporadaAnime.htm">Ver Registros</a>
            </div>
