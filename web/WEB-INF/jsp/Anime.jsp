<%-- 
    Document   : Anime
    Created on : 11/07/2022, 11:33:16 PM
    Author     : Raúl
--%>
        ...
        <div class="container">
            ...
            <div class="owl-carousel project-carousel wow fadeInUp" data-wow-delay="0.1s">
                ...
                <div class="project-item border rounded h-100 p-4" data-dot="05">
                    <div class="position-relative mb-4">
                        <img class="img-fluid rounded" src="img/Anime/Pelicula.jpg" alt="">
                        <a href="buscarPelicula.htm"><i class="fa fa-eye fa-2x"></i></a>
                    </div>
                    <h6>Pelicula</h6>
                    <span>Es el filme en donde se narra una historia.</span>
                </div>
            </div>
        </div>
    </div>
