<%-- 
    Document   : listaAuditoriaPelicula
    Created on : 13/07/2022, 10:51:56 PM
    Author     : Raúl
--%>
...
<head>
    ...
    <title>Lista Cambios Pelicula</title>
...
<body>
    ...
    <div class="card text-white text-center">
        <div class="card-header bg-success">
            <h4 class="text-white">Lista General de Cambios Peliculas</h4>
            <div style="float: right">
                <a class="btn btn-outline-light" href="listaPelicula.htm">Ver Registros</a>
            </div>
