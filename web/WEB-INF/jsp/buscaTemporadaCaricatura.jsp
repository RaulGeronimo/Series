...
<body>
    ...
    <div class="card text-white text-center">
        <div class="card-header bg-success">
            <!-- <h4 class="text-white">Lista General Temporadas Caricaturas</h4> -->
            ...
            <div style="float: right">
                ...
                <a class="btn btn-outline-light" href="buscaTemporadaCaricatura2.htm?idCaricatura=${Nombre[0].idCaricatura}">Otra
                    Vista</a>
            </div>
        </div>
        <div class="card-body bg-dark scrollmenu">
            ...
            <a href="listaCaricatura.htm" class="btn btn-outline-success btn-lg">Regresar</a>
        </div>
    </div>
    <!-- Tabla Fin -->
