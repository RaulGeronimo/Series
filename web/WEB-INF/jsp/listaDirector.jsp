<%-- 
    Document   : listaDirector
    Created on : 13/07/2022, 07:15:17 PM
    Author     : Raúl
--%>
...
<body>
    ...
    <div class="card text-white text-center">
        <div class="card-header bg-success">
            <h4 class="text-white">Lista General Director</h4>
            <div style="float: left">
                <a class="btn btn-outline-light" href="altaDirector.htm">Agregar Registro</a>
            </div>
            <div style="float: right">
                <a class="btn btn-outline-light" href="listaAuditoriaDirector.htm">Ver Cambios</a>
            </div>
        </div>
                ...
                <tbody>
                    <c:forEach var="dato" items="${Lista}">
                        <tr>
                            ...
                            <td>${dato.Estado}</td>
                            <td>
                                <a href="editarDirector.htm?idDirector=${dato.idDirector}" class="btn btn-warning">
                                ...
                                <a href="eliminarDirector.htm?idDirector=${dato.idDirector}"
...
<script src="js/Exportar/Director.js"></script>
