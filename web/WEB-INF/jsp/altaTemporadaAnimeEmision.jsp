<%-- 
    Document   : altaTemporadaAnimeEmision
    Created on : 26/07/2022, 02:02:50 PM
    Author     : Raúl
--%>
...
<head>
    ...
    <title>Alta Temporadas Anime</title>
    ...
    <div class="col-md-5 offset-md-3 text-white">
        <div class="card">
            <div class="card-header bg-success">
                <h3 class="text-white text-center">Nueva Temporada Anime</h3>
                <div style="float: right">
                    <a class="btn btn-outline-light" href="altaTemporadaAnime.htm">Finalizado</a>
                </div>
            </div>
            <div class="card-body bg-dark">
                <form method="POST">
                    ...
                    <div class="card-body">
                        <div class="input-group mb-3">
                            ...
                            <select name="idAnime" id="idAnime" class="form-select" aria-label="Default select example"
                                required autofocus>
                                <option selected disabled value="">Selecciona un Anime</option>
                    ...
                    <!-- Nombre -->
                    <div class="card-body">
                        <input type="text" name="nombre" placeholder="Nombre de la Temporada:" class="form-control" required>
                    </div>
