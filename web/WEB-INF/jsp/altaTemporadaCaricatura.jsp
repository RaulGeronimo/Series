<%-- 
    Document   : altaTemporadaCaricatura
    Created on : 14/07/2022, 11:08:57 PM
    Author     : Raúl
--%>
...
<head>
    ...
    <title>Alta Temporadas Caricaturas</title>
    ...
    <div class="col-md-5 offset-md-3 text-white">
        <div class="card">
            <div class="card-header bg-success">
                <h3 class="text-white text-center">Nueva Temporada Caricatura</h3>
                <div style="float: right">
                    <a class="btn btn-outline-light" href="altaTemporadaCaricaturaEmision.htm">Emision</a>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="input-group mb-3">
                            ...
                            <select name="idCaricatura" id="idCaricatura" class="form-select"
                                ...
                                <option selected disabled value="">Selecciona una Caricatura</option>
