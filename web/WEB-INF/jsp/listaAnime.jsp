<%-- 
    Document   : listaAnime
    Created on : 15/07/2022, 02:54:06 PM
    Author     : Raúl
--%>
...
<body>
    ...
    <div class="card text-white text-center">
        <div class="card-header bg-success">
            <h4 class="text-white">Lista General Animes</h4>
            <div style="float: left">
                <a class="btn btn-outline-light" href="altaAnime.htm">Agregar Registro</a>
            </div>
            <div style="float: right">
                <a class="btn btn-outline-light" href="listaAuditoriaAnime.htm">Ver Cambios</a>
            </div>
        </div>
                ...
                <tbody>
                    <c:forEach var="dato" items="${Lista}">
                        <tr>
                            ...
                            <td>
                                <a href="editarAnime.htm?idAnime=${dato.idAnime}" class="btn btn-warning">
                                ...
                                <a href="eliminarAnime.htm?idAnime=${dato.idAnime}"
                                ...
                                <a target="_blank" href="buscaTemporadaAnime2.htm?idAnime=${dato.idAnime}" class="btn btn-success">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
...
<script src="js/Exportar/Anime.js"></script>
