<%-- 
    ...
    Created on : 13/07/2022, 04:17:53 PM
    Author     : Raúl
--%>
...
<body>
    ...
    <div class="card text-white text-center">
        <div class="card-header bg-success">
            <h4 class="text-white">Lista General Genero</h4>
            <div style="float: right">
                <a class="btn btn-outline-light" href="altaGenero.htm">Agregar Registro</a>
            </div>
...
<script src="js/Exportar/Genero.js"></script>
