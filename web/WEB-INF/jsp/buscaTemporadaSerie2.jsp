    ...
    <div class="card text-white" style="margin-bottom: 1rem;">
        <div class="card-header bg-success">
            ...
            <div style="float: right">
                ...
                <a href="listaSerie.htm" class="btn btn-outline-light">Regresar</a>
                <a class="btn btn-outline-light" href="listaAuditoriaTemporadaSerie.htm">Ver Cambios</a>
                <a class="btn btn-outline-light" href="buscaTemporadaSerie.htm?idSerie=${Nombre[0].idSerie}">Otra
                    Vista</a>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-4" style="margin-bottom: 1.5rem;">
            <div class="card text-center bg-dark scrollmenu">
                <img src="${Nombre[0].Portada}" alt="Imagen de la Serie">
            </div>
        </div>
