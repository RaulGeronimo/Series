<%-- 
    Document   : buscaTemporadaSerie
    Created on : 16/07/2022, 04:27:18 PM
    Author     : Raúl
--%>
...
<head>
    ...
    <title>Lista Temporadas Series</title>
...
<body>
        ...
        <div class="container text-center py-5">
            ...
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center mb-0">
                    ...
                    <li class="breadcrumb-item text-primary active" aria-current="page"><a style="color: #0d6efd;" href="Series.htm">Series</a></li>
    ...
    <div class="card text-white text-center">
        <div class="card-header bg-success">
            <h3 class="text-white">Temporadas de: <br>${Nombre[0].Nombre}</h3>
            <!-- <h4 class="text-white">Lista General Temporadas Series</h4> -->
            <div style="float: left">
                <a class="btn btn-outline-light" href="altaTemporadaSerie.htm">Agregar Registro</a>
            </div>
            <div style="float: right">
                <a class="btn btn-outline-light" href="listaAuditoriaTemporadaSerie.htm">Ver Cambios</a>
                <a class="btn btn-outline-light" href="buscaTemporadaSerie2.htm?idSerie=${Nombre[0].idSerie}">Otra
                    Vista</a>
            </div>
        </div>
        <div class="card-body bg-dark scrollmenu">
                ...
                <tbody>
                    <c:forEach var="dato" items="${Lista}">
                        <tr>
                            ...
                            <td>
                                <a href="editarTemporadaSerie.htm?idTemporada=${dato.idTemporada}" target="_blank"
                                ...
                                <a href="eliminarTemporadaSerie.htm?idTemporada=${dato.idTemporada}"
            ...
            <a href="listaSerie.htm" class="btn btn-outline-success btn-lg">Regresar</a>
        </div>
    </div>
    <!-- Tabla Fin -->
...
<script src="js/Exportar/TemporadasSerie.js"></script>
