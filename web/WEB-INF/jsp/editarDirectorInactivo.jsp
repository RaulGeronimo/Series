<%-- 
    Document   : editarDirector
    Created on : 13/07/2022, 07:15:37 PM
    Author     : Raúl
--%>
...
<head>
    ...
    <title>Actualiza Director</title>
        ...
        <div class="card">
            <div class="card-header bg-success">
                ...
                <div style="float: right">
                    <a class="btn btn-outline-light"
                        href="editarDirector.htm?idDirector=${Lista[0].idDirector}">Director Activo</a>
                </div>
            </div>
            <div class="card-body bg-dark">
                <form method="POST">
                    ...
                    <!-- Apellidos -->
                    <div class="card-body">
                        <input type="text" name="apellidos" placeholder="Apellidos del Director:" class="form-control" required value="${Lista[0].Apellidos}">
                    </div>

                    <!-- Nombre de Director -->
                    <div class="card-body">
                        <input type="text" name="nombreDirector" placeholder="Alias:" class="form-control" required value="${Lista[0].NombreArtistico}">
                    </div>
                    ...
                    <div class="card-body">
                        <div class="input-group mb-3">
                            ...
                            <select name="sexo" id="Sexo" class="form-select" aria-label="Default select example"
                                required>
                                <option selected value="${Lista[0].sexo}">${ListaDirector[0].sexo}</option>
                    ...
                    <div class="card-body">
                        <input type="number" name="estatura" class="form-control" placeholder="Estatura en Metros"
                            step="0.01" min="0" max="10" required value="${Lista[0].Estatura}" />
                    </div>
                    ...
                    <div class="card-body">
                        <div class="input-group mb-3">
                            ...
                            <select name="nacionalidad" id="Nacionalidad" class="form-select"
                                ...
                                <option selected value="${Lista[0].Nacionalidad}">${ListaDirector[0].Pais}
                                </option>
