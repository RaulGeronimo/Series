...
public class TemporadasSeries {
    ...
    public TemporadasSeries(){
        
    }

    public TemporadasSeries(int idTemporada, int idSerie, String nombre, int capitulos, double calificacion) {
