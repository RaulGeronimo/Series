...
public class PeliculaAnime {
    ...
    public PeliculaAnime(int idPelicula, String nombre, String otrosNombres, int idProductora, int idDistribuidora, int genero, String tipo, int clasificacion, double calificacion, int idDirector, String Portada, int idTemporadaEmision, int idEstudio) {
